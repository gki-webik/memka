<template>
  <main>
    ...
    <div class="block3" id="b3">
      ...
      <div class="items">
        <div class="item">
          <img src="/assets/images/5.png" class="is-5" alt="" loading="lazy" />
          <div class="title"><span>Анимированный стикер</span></div>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <div class="title is-mem"><span>Мем стикер</span></div>
        </div>
        <div class="item">
          <img
